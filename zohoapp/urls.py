...
urlpatterns = [
    ...
    path('create_account_journal/',views.create_account_journal, name='create_account_journal'),
    path('account_edit_journal/',views.account_edit_journal, name='account_edit_journal'),
